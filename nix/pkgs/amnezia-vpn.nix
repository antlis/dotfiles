...
let
  ...
  amnezia-xray = callPackage ./amnezia-xray.nix { };

  dev-agw-public-key = lib.replaceStrings [ "\n" ] [ "\\n" ] (
    builtins.readFile ./amnezia-dev-agw-public-key.pem
  );
  ...
  prod-agw-public-key = lib.replaceStrings [ "\n" ] [ "\\n" ] (
    builtins.readFile ./amnezia-prod-agw-public-key.pem
  );
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "amnezia-vpn";
    repo = "amnezia-client";
    rev = "e9ed5b59a4484d8a246e7b0e772bea65b678c607";
    hash = "sha256-lo8fkd7lUpc5cMyVs3McdSPdDb01FQH0/Brkn2005HU=";
